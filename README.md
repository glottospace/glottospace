...
14. glottosave: save output generated by glottospace (data, figures,
    maps, etc.).
...
glottomap_rips_filt(glottodata = awk, r = 6, maxscale = 7, is_animate = FALSE) 
```
...
glottomap_rips_filt(glottodata = awk, r = 8, maxscale = 10, is_animate = TRUE, 
