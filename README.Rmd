...
Found the following files/directories:checking for non-standard things in the check directory ... NOTE
Found the following files/directories:fraSometimes you don't find a match:
```{r glottosearch3}
