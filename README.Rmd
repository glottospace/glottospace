...
when `metric="anderberg"`, it returns the Anderberg dissimarity [@similarity].
...
Suppose $A$ and $B$ are two languages containing constructions $\{A_i\}_{i\in I}$ and $\{B_j\}_{j\in J}$ respectively.
