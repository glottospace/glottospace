...
```
The package builds on the [glottolog](https://glottolog.org/) database and uses several rspatial packages, of which **sf** and **raster** are the most important ones. Please cite those as well. 
