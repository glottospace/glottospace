...
When glottodata = "phoible" or "phoiblespace",
you randomly choose only one sample for all the duplicated glottocodes,
and you can load the non-spatial/spatial-enhanced version of [Phoible](https://phoible.org/).
If you fix the value of seed, 
you can make a reproducible output.
...
When glottodata = "phoible_raw_param_sf",
you can load an sf object of the geographical distribution for all parameter IDs in raw [Phoible](https://phoible.org/).
...
When glottodata = "phoible_param_sf",
the function first randomly choose only one sample for all the duplicated glottocodes,
and then load the geographical distribution for all parameter IDs as an sf object.
If you set the value of seed, 
you can then create a reproducible dataset.
